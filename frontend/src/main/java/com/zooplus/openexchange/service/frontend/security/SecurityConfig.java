package com.zooplus.openexchange.service.frontend.security;

import com.zooplus.openexchange.service.frontend.controllers.v1.Version;
import com.zooplus.openexchange.service.frontend.security.filters.AuthenticationFilter;
import com.zooplus.openexchange.service.frontend.security.providers.DataSourceAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private String[] actuatorEndpoints() {
        return new String[]{Version.ADMIN_ENDPOINT, Version.USER_REGISTRATION_PATH};
    }

    private String[] permitAllEndpoints() {
        return new String[]{Version.USER_LOGIN_PATH};
    }

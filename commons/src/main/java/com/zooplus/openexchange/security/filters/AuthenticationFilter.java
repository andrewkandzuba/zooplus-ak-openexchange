...
import com.zooplus.openexchange.security.SecurityConfigurationDetails;
...
import static com.zooplus.openexchange.security.SecurityConfigurationDetails.X_AUTH_PASSWORD_HEADER;
import static com.zooplus.openexchange.security.SecurityConfigurationDetails.X_AUTH_USERNAME_HEADER;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    public AuthenticationFilter(AuthenticationManager authenticationManager,
                                SecurityConfigurationDetails securityConfigurationDetails) {
        this.authenticationManager = authenticationManager;
        this.securityConfigurationDetails = securityConfigurationDetails;
    }
    ...
    private boolean postToAuthenticate(HttpServletRequest httpRequest, String resourcePath) {
        return securityConfigurationDetails.authenticationPath().equalsIgnoreCase(resourcePath)

package com.zooplus.openexchange.service.frontend.security.filters;
...
import static com.zooplus.openexchange.service.frontend.security.SecurityConfig.X_AUTH_PASSWORD_HEADER;
import static com.zooplus.openexchange.service.frontend.security.SecurityConfig.X_AUTH_USERNAME_HEADER;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean postToAuthenticate(HttpServletRequest httpRequest, String resourcePath) {
        return Version.USER_LOGIN_PATH.equalsIgnoreCase(resourcePath) && httpRequest.getMethod().equals("POST");
    }
